 ...
 */
package edu.chalmers.dat255.group09.Alarmed.constants;
...
public final class Constants {
	...
	public static final String MINUTES = PACKAGE + ".minutes";
	public static final String DAYSOFWEEK = PACKAGE + ".daysofweek";
	public static final String DAYS = PACKAGE + ".days";
	public static final String VOLUME = PACKAGE + ".volume";
	public static final String MODULE = PACKAGE + ".module";
